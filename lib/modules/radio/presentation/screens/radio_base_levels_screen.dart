...
class RadioBaseLevelsScreen extends StatelessWidget {
  const RadioBaseLevelsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: BlocProvider(
          create: (context) => RadioBaseLevelsBloc(sl())..add(GetBaseLevelsEvent()),
          child: BlocConsumer<RadioBaseLevelsBloc, BaseState<List<RadioBaseLevel>>>(
  ...
  void _onLevelPressed(BuildContext context, BaseState<List<RadioBaseLevel>> state) {
  }
}