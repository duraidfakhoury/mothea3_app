...
class RadioLevelLessonsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: BlocProvider(
          create: (context) => RadioLevelLessonsBloc(sl())..add(GetLevelLessonsEvent(levelId: level.id)),
          child: BlocConsumer<RadioLevelLessonsBloc, BaseState<List<RadioLevelLesson>>>(
  ...
  void _onLessonPressed(BuildContext context, BaseState<List<RadioLevelLesson>> state) {
