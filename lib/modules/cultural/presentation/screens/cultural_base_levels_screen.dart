...
class CulturalBaseLevelsScreen extends StatelessWidget {
  const CulturalBaseLevelsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: BlocProvider(
          create: (context) =>
              CulturalBaseLevelsBloc(sl())..add(GetBaseLevelsEvent()),
          child:
              BlocConsumer<
                CulturalBaseLevelsBloc,
                BaseState<List<CulturalBaseLevel>>
              >(
                                      ...
                                      Expanded(
                                        child: Column(
                                          ...
                                          children: [
                                            Text(
                                              LocaleKeys
                                                  .youHaveThreeLessonsToCompleteThisCourse
                                                  .tr(),
                                              style: TextStyle(
                                                color: AppColors.white
                                                    .withOpacity(0.6),
  ...
  void _onLessonPressed(
    ...
    BaseState<List<CulturalBaseLevel>> state,
  ) {
