...
class TelevisionLevelLessonsScreen extends StatelessWidget {
  ...
  const TelevisionLevelLessonsScreen({super.key, required this.level});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        child: BlocProvider(
          create: (context) =>
              TelevisionLevelLessonsBloc(sl())
                ..add(GetLevelLessonsEvent(levelId: level.id)),
          child:
              BlocConsumer<
                TelevisionLevelLessonsBloc,
                BaseState<List<TelevisionLevelLesson>>
              >(
