...
class TelevisionLessonScreen extends StatefulWidget {
  final int levelId;
  final TelevisionLevelLesson lesson;

  const TelevisionLessonScreen({
    super.key,
  ...
  @override
  State<TelevisionLessonScreen> createState() => _TelevisionLessonScreenState();
}

class _TelevisionLessonScreenState extends State<TelevisionLessonScreen>
